...
begin
  ShowMessage('—пасибо за то что пользуетесь приложением' + #13 + #10 +
    '≈сли есть какие либо предложени€/пожелани€ и способность св€затьс€ со мной - пишите'
    + #13 + #10 + '√отов прин€ть небольшие донаты за бессоные ночи :))' + #13 +
    #10 + 'QIWI:https://qiwi.com/n/AGOOM395' + #13 + #10 +
    'ѕополнение по никнейму:AGOOM395');
end;
...
begin
  ...
  begin
    ...
    ShowMessage('¬ведите название книги');
end;
